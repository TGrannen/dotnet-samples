...
namespace FeatureFlags.Split.WebAPI.Controllers;
...
public class TestController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<IActionResult> Get(string split = "test_split")
    {
    ...
    [HttpGet("json")]
    public async Task<IActionResult> GetConfig(string split = "json_split")
    {
