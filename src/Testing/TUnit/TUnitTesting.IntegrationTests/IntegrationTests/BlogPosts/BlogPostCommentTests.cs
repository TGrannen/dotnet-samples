using TUnitTesting.IntegrationTests.IntegrationTests.BlogPosts.Shared;

namespace TUnitTesting.IntegrationTests.IntegrationTests.BlogPosts;

[Category("Integration")]
public class BlogPostCommentTests : BlogPostTestBase
{
    [Test]
