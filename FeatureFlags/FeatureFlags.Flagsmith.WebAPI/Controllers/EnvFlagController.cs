...
[ApiController]
[Route("[controller]")]
public class EnvFlagController : ControllerBase
{
    private readonly IEnvFeatureService _service;
    private readonly IEnvJsonFeatureService _jsonFeatureService;

    public EnvFlagController(IEnvFeatureService service, IEnvJsonFeatureService jsonFeatureService)
    {
        _service = service;
